...
function App() {
  ...
  return (
    <div className="min-h-screen bg-ink-950 p-4">
      <nav className="nav-cinematic mb-6 flex flex-wrap items-center gap-x-4 gap-y-2 pb-4 text-sm text-ink-100/75 sm:gap-x-5">
        <Link className="wordmark-glow font-poster text-2xl tracking-wide text-ink-100 sm:text-3xl" to="/">Panel &amp; Co.</Link>
