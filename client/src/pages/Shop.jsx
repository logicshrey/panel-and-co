...
function Shop() {
  ...
  return (
    <div className="flex min-h-screen flex-col gap-6 bg-ink-950 px-4 py-6 text-ink-100 sm:px-6 sm:py-10 md:flex-row md:gap-8">
      <aside className="panel h-fit w-full shrink-0 bg-ink-900 p-4 text-ink-100/80 md:w-56">
